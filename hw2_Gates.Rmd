...
# Proceed with your data processing (e.g., save the merged data)
...
process_teosinte_data <- function(teosinte_data) {
  ...
  lapply(1:10, function(chr) {
    ...
    # Write the increasing data to a file for the current chromosome
    ...
    # Write the decreasing data to a file for the current chromosome
